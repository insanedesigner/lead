...
$(function() {
    ...
    var runDescriptionTextEditor   =   function(){
        ...
        tinymce.init({
            selector: 'textarea#desc1',  // change this value according to your html
            images_upload_url: '../api/coursesCategoryDescriptionImageUpload',
            images_upload_base_path: '../',
            images_upload_credentials: true,
            plugins: 'preview image link media table insertdatetime imagetools help',
            toolbar: 'formatselect | bold italic strikethrough forecolor backcolor | link | alignleft aligncenter alignright alignjustify  | numlist bullist outdent indent  | removeformat',
    ...
    var runCategoryValidation =   function(){
       ...
       /* $.validator.addMethod('thumbImageSelectedOrNot', function(value, element, param) {
        ...
        $.validator.addMethod("valueNotEquals", function(value, element, arg){
            ...
            //return arg !== value;
            return value!=0;
        }, "Please select a Stream Name.");

        $("#addCoursesCategoryForm").validate({
            rules: {
            ...
            messages: {
                courses_name :{
                    required: "Required Courses Category Name."
                },
                featured_image_name: {
