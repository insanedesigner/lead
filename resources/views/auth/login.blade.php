...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="{!! asset('public/assets/plugins/bootstrap/css/bootstrap.min.css') !!}" media="all" rel="stylesheet" type="text/css" />
    ...
    <link href="{!! asset('public/assets/css/colors/blue.css') !!}" media="all" rel="stylesheet" type="text/css" />
...
<section id="wrapper" class="login-register " {{--style="background-image:url(../assets/images/background/login-register.jpg);"--}}>
    <div class="login-box card">
        <div class="card-body">
            ...
            <form class="form-horizontal form-material" method="POST" id="loginform" action="{{ route('handleLogin') }}">
                {{ csrf_field() }}
                ...
                <div class="form-group ">
                    <div class="col-xs-12">
                        <input class="form-control username" id="username" name="username" type="text" required="" placeholder="Username"> </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
                        <input class="form-control password" id="password" name="password" type="password" required="" placeholder="Password"> </div>
                </div>
            ...
            {{--<form class="form-horizontal form-material" method="POST" id="loginform" action="{{ route('handleLogin') }}">
                ...
                <div class="form-group m-t-40">
                    <div class="col-xs-12">
                        <input class="form-control username" name="username" id="username" type="text" required="" placeholder="Username">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
                        <input class="form-control password" name="password" id="password" type="password" required="" placeholder="Password">
                    </div>
                </div>
                --}}{{--<div class="form-group">
                    <div class="col-md-12">
