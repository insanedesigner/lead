    ...
    <nav class="sidebar-nav">
        <ul id="sidebarnav">
            ...
            <li class="{{$dashboardActive}}">
                <a class="{{$dashboardActive}}" href="dashboard" >
                    <i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard</span>
                </a>
            </li>
            {{--<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Role Management</span></a>
                <ul aria-expanded="false" class="collapse">
                    <li class="{{$addroleActive }}"><a class="{{$addroleActive}}" href="addrole">Add / Edit Role</a></li>
