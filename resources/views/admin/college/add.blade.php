                ...
                <div class="col-md-12">
                    ...
                    <!-- Nav tabs -->
                        <ul class="nav nav-tabs customtab" role="tablist">
                            ...
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#info" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Info</span></a> </li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="contact" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <div class="form-group m-b-40">
                                            {!! Form::text('region', $data['region'], ['class' => 'form-control','id'=>'region']) !!}
                                            <span class="bar"></span>
                                            <label for="region">Region / Location</label>
                                        </div>
                                        <div class="form-group m-b-40">
                                            {!! Form::text('pin', $data['pincode'], ['class' => 'form-control','id'=>'pin']) !!}
                                            <span class="bar"></span>
