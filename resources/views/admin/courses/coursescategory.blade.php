                                ...
                                <div class="tab-content tabcontent-border">
                                    <div class="tab-pane  p-20 active" id="contents" role="tabpanel">
                                        <div class="form-group m-b-40 m-t-40">
                                            {{ Form::select('id_stream', $streamData, $coursesData['idStream'], ['id' => 'id_stream','class'=>'form-control p-0 id_stream']) }}
                                            <span class="bar"></span>
                                            <label for="id_stream">Stream Name <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="form-group m-b-40 m-t-40">
                                            {!! Form::text('courses_name', $coursesData['coursesName'], ['class' => 'form-control','id'=>'courses_name']) !!}
                                            <span class="bar"></span>
                                            <label for="courses_name">Category Name <span class="text-danger">*</span></label>
                                        </div>
...
<script src="../public/assets/js/admin/courses/category-add.js"></script>
