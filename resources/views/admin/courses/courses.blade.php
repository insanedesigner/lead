                                ...
                                <div class="tab-content tabcontent-border">
                                    <div class="tab-pane active" id="contents" role="tabpanel">
                                            ...
                                            <div class="form-group m-b-40 m-t-40">
                                                {{ Form::select('stream_name', $streamData,$coursesData['idStream'], ['id' => 'stream_name','class'=>'form-control p-0 stream_name']) }}
                                                <span class="bar"></span>
                                                <label for="id_stream">Streams <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="form-group m-b-40 m-t-40">
                                                {{ Form::select('courses_category', $categoryData, $coursesData['idCategory'], ['id' => 'courses_category','class'=>'form-control p-0 courses_category']) }}
                                                <span class="bar"></span>
                                                <label for="id_stream">Courses Category </label>
                                            </div>
                                            <div class="form-group m-b-40 m-t-40">
                                                {!! Form::text('course_name', $coursesData['coursesName'], ['class' => 'form-control','id'=>'course_name']) !!}
                                                <span class="bar"></span>
                                                <label for="courses_name">Course Name <span class="text-danger">*</span></label>
                                            </div>
                                    ...
                                    <div class="tab-pane" id="info" role="tabpanel">
                                        <div class="p-20">
                                            <div class="form-group m-b-40 m-t-40">
                                                {{ Form::select('status', $ed, $coursesData['status'], ['id' => 'active_status','class'=>'form-control p-0']) }}
                                                <span class="bar"></span>
